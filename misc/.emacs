...
(setq casey-todo-file "f:/gamedev/shadowbiz/code/todo.txt")
(setq casey-log-file "f:/gamedev/shadowbiz/code/log.txt")
...
(defun casey-big-fun-c-hook ()
  ...
  (defun casey-header-format ()
     ...
     (insert "   $Date: $\n")
     (insert "   $Revision: $\n")
     (insert "   $Creator: Alexander Udov $\n")
     (insert "   $Notice: (C) Copyright 2015 by Shadowbiz. All Rights Reserved. $\n")
     (insert "   ======================================================================== */\n")
     (insert "\n")
     (insert "#define ")
     (push-mark)
...
; (define-key global-map [M-delete] 'kill-whole-line)
